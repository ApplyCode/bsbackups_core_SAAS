...
const SidebarContent = ({t}) => {
  ...
  const { admin } = useSelector(state => state.profile.user)
      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/backups" className=" waves-effect">
                <i className="ti-server"></i>
                <span>{t("Backup Routines")}</span>
              </Link>
            </li>
            <li>
              <Link to="/download-backups" className=" waves-effect">
